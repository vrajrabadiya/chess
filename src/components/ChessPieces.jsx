...
// Standard Wikipedia (Cburnett) Chess Pieces
// Rendered in high-quality SVG format with Chess.com style solid color scheme (Cream-White & Charcoal Wood).

const Pawn = ({ isWhite }) => {
  if (isWhite) {
    return (
      <svg viewBox="0 0 45 45" className="chess-piece-svg" width="100%" height="100%">
        <g fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" strokeLinecap="round" />
        </g>
      </svg>
    );
  } else {
    return (
      <svg viewBox="0 0 45 45" className="chess-piece-svg" width="100%" height="100%">
        <g fill="#45423e" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" strokeLinecap="round" />
        </g>
      </svg>
    );
...
const Knight = ({ isWhite }) => {
  if (isWhite) {
    return (
      <svg viewBox="0 0 45 45" className="chess-piece-svg" width="100%" height="100%">
        <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <circle cx="9" cy="25.5" r="0.5" fill="#000000" stroke="#000000" />
          <ellipse cx="14.5" cy="15.5" rx="0.5" ry="1.5" transform="matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)" fill="#000000" stroke="#000000" />
        </g>
      </svg>
    );
  } else {
    return (
      <svg viewBox="0 0 45 45" className="chess-piece-svg" width="100%" height="100%">
        <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" fill="#45423e" stroke="#000000" />
          <path d="M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10" fill="#45423e" stroke="#000000" />
          <circle cx="9" cy="25.5" r="0.5" fill="#ececec" stroke="#ececec" />
          <ellipse cx="14.5" cy="15.5" rx="0.5" ry="1.5" transform="matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)" fill="#ececec" stroke="#ececec" />
...
const Bishop = ({ isWhite }) => {
  if (isWhite) {
    ...
    return (
      <svg viewBox="0 0 45 45" className="chess-piece-svg" width="100%" height="100%">
        <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2zm6-4c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2zM25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 1 1 5 0z" fill="#45423e" strokeLinecap="butt" />
    ...
    return (
      <svg viewBox="0 0 45 45" className="chess-piece-svg" width="100%" height="100%">
        <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5" fill="#45423e" strokeLinecap="butt" strokeLinejoin="miter" />
          <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z" fill="#45423e" />
...
// Dummy element so we don't break App.jsx's import
export const ChessGradients = () => null;

export const ChessPiece = ({ type, color }) => {
  const isWhite = color === 'w';
  
  switch (type.toLowerCase()) {
    case 'p': return <Pawn isWhite={isWhite} />;
    case 'n': return <Knight isWhite={isWhite} />;
    case 'b': return <Bishop isWhite={isWhite} />;
    case 'r': return <Rook isWhite={isWhite} />;
    case 'q': return <Queen isWhite={isWhite} />;
    case 'k': return <King isWhite={isWhite} />;
    default: return null;
  }
};
